...
export const quickReferenceTabs: QuickReferenceTab[] = [
  {
    ...
    label: "4 cm",
    rows: [
      { label: "4 mil at 4 cm", result: "10 m" },
      { label: "2.7 mil at 4 cm", result: "15 m" },
      { label: "2 mil at 4 cm", result: "20 m" },
      { label: "1.6 mil at 4 cm", result: "25 m" },
      { label: "1.3 mil at 4 cm", result: "30 m" },
      { label: "1.1 mil at 4 cm", result: "35 m" },
      { label: "1 mil at 4 cm", result: "40 m" },
      { label: "0.9 mil at 4 cm", result: "45 m" },
      { label: "0.8 mil at 4 cm", result: "50 m" },
    ],
  },
  {
    id: "size-6",
    label: "6 cm",
    rows: [
      { label: "6 mil at 6 cm", result: "10 m" },
      { label: "4 mil at 6 cm", result: "15 m" },
      { label: "3 mil at 6 cm", result: "20 m" },
      { label: "2.4 mil at 6 cm", result: "25 m" },
      { label: "2 mil at 6 cm", result: "30 m" },
      { label: "1.7 mil at 6 cm", result: "35 m" },
      { label: "1.5 mil at 6 cm", result: "40 m" },
      { label: "1.3 mil at 6 cm", result: "45 m" },
      { label: "1.2 mil at 6 cm", result: "50 m" },
    ],
  },
  {
    id: "size-8",
    label: "8 cm",
    rows: [
      { label: "8 mil at 8 cm", result: "10 m" },
      { label: "5.3 mil at 8 cm", result: "15 m" },
      { label: "4 mil at 8 cm", result: "20 m" },
      { label: "3.2 mil at 8 cm", result: "25 m" },
      { label: "2.7 mil at 8 cm", result: "30 m" },
      { label: "2.3 mil at 8 cm", result: "35 m" },
      { label: "2 mil at 8 cm", result: "40 m" },
      { label: "1.8 mil at 8 cm", result: "45 m" },
      { label: "1.6 mil at 8 cm", result: "50 m" },
    ],
  },
  {
    id: "size-10",
    label: "10 cm",
    rows: [
      { label: "10 mil at 10 cm", result: "10 m" },
      { label: "6.7 mil at 10 cm", result: "15 m" },
      { label: "5 mil at 10 cm", result: "20 m" },
      { label: "4 mil at 10 cm", result: "25 m" },
      { label: "3.3 mil at 10 cm", result: "30 m" },
      { label: "2.9 mil at 10 cm", result: "35 m" },
      { label: "2.5 mil at 10 cm", result: "40 m" },
      { label: "2.2 mil at 10 cm", result: "45 m" },
      { label: "2 mil at 10 cm", result: "50 m" },
    ],
  },
  {
    id: "size-20",
    label: "20 cm",
    rows: [
      { label: "10 mil at 20 cm", result: "20 m" },
      { label: "8 mil at 20 cm", result: "25 m" },
      { label: "6.7 mil at 20 cm", result: "30 m" },
      { label: "5.7 mil at 20 cm", result: "35 m" },
      { label: "5 mil at 20 cm", result: "40 m" },
      { label: "4.4 mil at 20 cm", result: "45 m" },
      { label: "4 mil at 20 cm", result: "50 m" },
    ],
  },
  {
    id: "size-30",
    label: "30 cm",
    rows: [
      { label: "10 mil at 30 cm", result: "30 m" },
      { label: "8.6 mil at 30 cm", result: "35 m" },
      { label: "7.5 mil at 30 cm", result: "40 m" },
      { label: "6.7 mil at 30 cm", result: "45 m" },
      { label: "6 mil at 30 cm", result: "50 m" },
    ],
  },
];
